...
- Name: Cross-Browser Compatibility Testing >> chromium Browser Tests >> Homepage loads correctly on chromium
- Location: D:\W123-project\tests\cross-browser.spec.ts:12:7
...
Call log:
  ...
  - waiting for locator('nav')
    ...
    at D:\W123-project\tests\cross-browser.spec.ts:20:43
```
